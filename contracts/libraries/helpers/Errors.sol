 ...
 * @author CBP
 * @notice Defines the error messages emitted by the different contracts of the CBP protocol
 */
library Errors {
  enum ReturnCode {
    SUCCESS,
  ...
  string public constant FUNCTION_IS_PAUSED = "105";
  ...
  string public constant VL_COLLECTION_NOT_LIST = "320";
