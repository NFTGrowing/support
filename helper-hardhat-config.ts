...
export const NETWORKS_RPC_URL: iParamsPerNetwork<string> = {
  ...
  [eEthereumNetwork.arbgoerli]: ALCHEMY_KEY
    ? `https://arbitrum-goerli.alchemyapi.io/v2/${ALCHEMY_KEY}`
...
export const NETWORKS_DEFAULT_GAS: iParamsPerNetwork<number> = {
  ...
  [eEthereumNetwork.sepolia]: 20 * GWEI,
  [eEthereumNetwork.arbgoerli]: 0.1 * GWEI,
